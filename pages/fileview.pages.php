...
<div class="ml-15">
	<!--<?php
	echo '<a class="btn btn-secondary" href="sectionview.pages.php?tn='.$sname.'">BACK</a>';
	?>-->
	...
	<button class="btn btn-danger ml-12" data-toggle="modal" data-target="#confirmModal">Delete</button>
		...
		<div class="modal-content">
			...
			<?php echo '<form method="POST" action="../includes/deletefile-section.inc.php?fn='.$fname.'&sn='.$sname.'&id='.$row['cs_id'].'">'; ?>
